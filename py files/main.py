...
def wrap_and_blend_images(processed_image_path, overlay_image_path, background_image_path, save_path, alpha=0.5):
    ...
    # Stretch the processed face horizontally to match the width of the overlay face
    overlay_width = overlay_right - overlay_left
    overlay_height = overlay_bottom - overlay_top
    processed_face_roi_resized = cv2.resize(processed_face_roi, (overlay_width, overlay_height))
...
def upload_image():
    try:
        ...
        if file:
            ...
            wrapped_and_blended_save_path = 'idk.png'
